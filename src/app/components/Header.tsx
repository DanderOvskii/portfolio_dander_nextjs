...
const Header = () => {
  ...
  return (
    <>
      <div className="w-full h-[10vh] flex items-center justify-start fixed font-[jose] z-10  ">
      ...
      <div id="Menu" className={`fixed w-full h-dvh bg-background-light ${menuOpen ? "translate-y-0" : "-translate-y-full"} transition-all duration-1000 flex flex-row right-0 z-10`}>
